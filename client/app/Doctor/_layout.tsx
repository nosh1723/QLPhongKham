        ...
        <ViewComponent>
            <>
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <View style={{backgroundColor: "#fff", padding: 12, marginBottom: 5}}>
                        <Text style={{fontWeight: 600, padding: 10, textAlign: 'center', fontSize: 18}}>Lịch khám</Text>
                        <CommonButton onPress={()=> setShow(!show)} style={{borderWidth: 1, borderColor: "#e7ebed", borderRadius: 8}} color='transparent'>
                    ...
                    <View style={{ padding: 12, backgroundColor: "#fff", marginBottom: 5}}>
